 ...
 */
! function(e, o) {
	"object" == typeof exports && "object" == typeof module ? module.exports = o(require("echarts")) : "function" == typeof define && define.amd ? define("LibraryWave", ["echarts"], o) : "object" == typeof exports ? exports.LibraryWave = o(require("echarts")) : e.LibraryWave = o(e.echarts)
}(this, function(e) {
	return function(e) {
		function o(n) {
					...
					formatter: function(e) {
					    ...
					    if (e.name) {
                            if (e.data.type == 'park') {
                                ...
                                return 0 == e.seriesIndex ? e.data.name + "：" + (e.data.value ? e.data.value : 0) : e.data ? e.data.district + "：" + e.value[2] : ""
                            }
                        }
		...
		n.prototype = {
			...
			createMap: function(e) {
				var o = {
					...
					n = this;
				n._addressJson = e.addressJson;
				var a = n._option;
				s.registerMap("china", i), e.icon && (a.series[1].symbol = "image://" + e.icon);
				var r = document.getElementsByClassName(e.dom)[0];
				r.style.width = e.width + "px", r.style.height = e.height + "px", a.series[0].data = e.data[0], a.series[1].data = e.data[1];
				var d = s.init(r);
				n._echartsInstance = d, d.setOption(a);
				var c = t(4),
					p = {};
				...
				var m = d.getZr();
					l = new s.graphic.Circle({});
				n._btnReturn = l;
				var g = new s.graphic.Group;
				g.add(l),
                m.add(g), $(e.back).on("click", function() {
                    $(e.back).hide();
					a.series[1].data = e.data[1], n._showMap("china", "中国")
				}), d.on("click", function(t) {
					if ("function" == typeof o.click && o.click(t), "china" == n._currentMap) {
                        if (t.name){
                            if (t.data.type){
                                return
                            }
                            $(e.back).show();
                            n._showProvince(p[t.name ? t.name : t.data.province]);
                            for (var i = [], s = 1; s < 2; s++) {
                                for (var r = 0; r < e.data[s].length; r++) t.data.province == e.data[s][r].province && i.push(e.data[s][r]);
                                a.series[s].data = i
                            }
                        }
					}
			...
			_showMap: function(e, o) {
				var t = this,
					n = t._option;
				n.series[0].map = e, n.geo.map = e;
				var i = t._echartsInstance;
				i.setOption(n, !0);
				var s = t._btnReturn;
				"china" != e ? s.show() : s.hide(), t._currentMap = e
			},
			_showProvince: function(e) {
				var o = this;
				$.get(o._addressJson + e.id + ".json", function(t) {
					s.registerMap(e.id, t), o._showMap(e.id, e.name)
				})
			}
		}, e.exports = n
	}, function(e, o) {
